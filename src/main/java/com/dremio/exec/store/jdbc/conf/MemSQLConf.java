...
@SourceType(value = "MemSQLARP", label = "MemSQL",uiConfig = "memsql-layout.json")
public class MemSQLConf extends AbstractArpConf<MemSQLConf> {
  private static final String ARP_FILENAME = "arp/implementation/memsql-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.memsql.MemSQLDriver";
